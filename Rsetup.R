...
# -Make a folder on your C drive to intall packages in: e.g. C:/R_Library (NOT IN PROGRAM FILES)
...
# character vector of all installed packages
...
# load desired packages (only if moving packages between workstations)
